          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://www.linkedin.com/company/sai-vinayaka-enterprises" className="h-10 w-10 bg-primary hover:bg-primary-dark rounded-full flex items-center justify-center transition duration-300">
                  <svg className="h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
